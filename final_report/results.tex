...
TODO: plot vertrauenswürdig? -> TSNE?
TODO: Metriken widersprechen sich, wie aussagekräftig?
TODO: bisher immer nur default einstellungen und nur n_cluster und n_components angepasst -> further inverstigation
TODO: conclusion -> es gibt so viele Algorithmen, bei denen man wiederum so viel optimieren und einstellen kann, dass es schwer ist, unter all dem das geeignete Werkzeug zu finden.
