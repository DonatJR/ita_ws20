...
def parse_xml(root, filename):
    ...
    for child in root.iter():
        ...
        filename = filename.replace(";", r'/').replace("tei.xml", "pdf").replace("https///", "https://")
        vals = [title, abstract, keywords, authors, filename, datasource, datasource_url]
